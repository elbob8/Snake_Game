...
public class Game_Panel extends JPanel implements ActionListener{
    ...
    public void draw(Graphics g){
        ...
        if(running){
            ...
            if(i == 0){
                ...
                g2.fillOval(x[i], y[i], UNIT_SIZE, UNIT_SIZE);
            }else{
    ...
    public void gameOver(Graphics g){
        ...
        g2.setColor(new Color(random.nextInt(255),random.nextInt(255),random.nextInt(255)));
        g2.setFont(new Font("Ink Free",Font.BOLD,40));
        FontMetrics fm1 = getFontMetrics(g2.getFont());
        g2.drawString("Score: " + applesEaten,(SCREEN_WIDTH - fm1.stringWidth("Score: " + applesEaten))/2,g.getFont().getSize());
        //Game Over text
        g2.setColor(Color.red);
        g2.setFont(new Font("Ink Free",Font.BOLD,75));
        FontMetrics fm2 = getFontMetrics(g2.getFont());
        g2.drawString("Game Over",(SCREEN_WIDTH - fm2.stringWidth("Game Over"))/2,SCREEN_HEIGHT/2);
    }
